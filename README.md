...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/RyanL-N/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/RyanL-N/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/RyanL-N/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/RyanL-N/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/RyanL-N/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/RyanL-N/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |       1 m 9.359 s         |       0 m 10.09 s         | 
| `pg_normalized_batch`  |       0 m 23.238 s        |       0 m 2.87 s          | 
| `pg_denormalized`      |       0 m 22.113 s        |       0 m 3.90 s          | 
